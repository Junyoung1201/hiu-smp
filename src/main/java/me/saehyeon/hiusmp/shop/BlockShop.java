...
public class BlockShop {
    public static void open(Player player) {
        ...
        ShopItem[] items = new ShopItem[] {
            ...
            new ShopItem("하얀색 콘크리트", Material.WHITE_CONCRETE, 10, 50),
            new ShopItem("밝은 회색 콘크리트", Material.LIGHT_GRAY_CONCRETE, 10, 50),
            new ShopItem("회색 콘크리트", Material.GRAY_CONCRETE, 10, 50),
            new ShopItem("검은색 콘크리트", Material.BLACK_CONCRETE, 10, 50),
            new ShopItem("빨간색 콘크리트", Material.RED_CONCRETE, 10, 50),
            new ShopItem("주황색 콘크리트", Material.ORANGE_CONCRETE, 10, 50),
            new ShopItem("갈색 콘크리트", Material.BROWN_CONCRETE, 10, 50),
            new ShopItem("노란색 콘크리트", Material.YELLOW_CONCRETE, 10, 50),
            new ShopItem("초록색 콘크리트", Material.LIME_CONCRETE, 10, 50),
            new ShopItem("녹색 콘크리트", Material.GREEN_CONCRETE, 10, 50),
            new ShopItem("청록색 콘크리트", Material.CYAN_CONCRETE, 10, 50),
            new ShopItem("하늘색 콘크리트", Material.LIGHT_BLUE_CONCRETE, 10, 50),
            new ShopItem("파란색 콘크리트", Material.BLUE_CONCRETE, 10, 50),
            new ShopItem("분홍색 콘크리트", Material.PINK_CONCRETE, 10, 50),
            new ShopItem("보라색 콘크리트", Material.PURPLE_CONCRETE, 10, 50),
