...
public class MinerShop {
    public static void open(Player player) {
        ...
        ShopItem[] items = new ShopItem[] {
            ...
            new ShopItem("철", Material.IRON_INGOT, 3,100),
            new ShopItem("금", Material.GOLD_INGOT, 120, 175),
            new ShopItem("다이아몬드", Material.DIAMOND, 3000, 15000),
            new ShopItem("에메랄드", Material.EMERALD, 4500,22500),
            new ShopItem("네더라이트", Material.NETHERITE_INGOT, 8000,40000)
        };
